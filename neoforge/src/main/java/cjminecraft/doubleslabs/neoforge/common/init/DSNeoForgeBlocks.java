...
public class DSNeoForgeBlocks {
    ...
    public static final DeferredHolder<Block, VerticalSlabBlock> VERTICAL_SLAB = BLOCKS.register(VERTICAL_SLAB_ID.getPath(), () -> new VerticalSlabBlock(VERTICAL_SLAB_PROPERTIES));
