...
public class DSNeoForgeBlockEntities {
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<? extends IDynamicSlabStateContainer>> DYNAMIC_SLAB_BLOCK_ENTITY =
            BLOCK_ENTITY_TYPES.register(DYNAMIC_SLAB_ID.getPath(), () ->
                    BlockEntityType.Builder.of(NeoForgeDynamicSlabBlockEntity::new,
                            DSNeoForgeBlocks.MIXED_SLAB.get(), DSNeoForgeBlocks.TRANSPARENT_MIXED_SLAB.get(), DSNeoForgeBlocks.VERTICAL_SLAB.get())
                            .build(null));
