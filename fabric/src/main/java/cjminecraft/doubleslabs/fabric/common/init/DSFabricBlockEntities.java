...
public class DSFabricBlockEntities {
    ...
    public static final BlockEntityType<? extends IDynamicSlabStateContainer> DYNAMIC_SLAB = BlockEntityType.Builder.of(FabricDynamicSlabBlockEntity::new, DSFabricBlocks.MIXED_SLAB, DSFabricBlocks.TRANSPARENT_MIXED_SLAB).build(null);
