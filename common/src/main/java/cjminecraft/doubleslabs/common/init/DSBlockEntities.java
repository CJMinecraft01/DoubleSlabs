...
public class DSBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<?>, BlockEntityType<? extends DynamicSlabBlockEntity<? extends ISlabStateContainer>>> DYNAMIC_SLAB = PROVIDER.register("dynamic_slab", () -> BlockEntityType.Builder.of(Services.PLATFORM.getBlockEntityFactory()::createDynamicSlabBlockEntity, DSBlocks.DOUBLE_SLAB.get()).build(null));
