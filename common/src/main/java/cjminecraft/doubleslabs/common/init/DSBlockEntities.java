...
public class DSBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<?>, BlockEntityType<? extends IDynamicSlabStateContainer>> DYNAMIC_SLAB = PROVIDER.register("dynamic_slab", () -> BlockEntityType.Builder.of(Services.PLATFORM.getBlockEntityFactory()::createDynamicSlabBlockEntity, DSBlocks.MIXED_SLAB.get()).build(null));
