...
public class DSBlockEntities {
    ...
    public static final Supplier<BlockEntityType<? extends IDynamicSlabStateContainer>> DYNAMIC_SLAB = () -> Services.PLATFORM.getBlockEntities().getDynamicSlabBlockEntity().get();
