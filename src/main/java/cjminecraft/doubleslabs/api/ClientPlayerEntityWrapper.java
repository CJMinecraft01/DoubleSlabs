...
public class ClientPlayerEntityWrapper extends ClientPlayerEntity {
    ...
    public ClientPlayerEntityWrapper(ClientPlayerEntity player, World world) {
        super(Minecraft.getInstance(), player.worldClient, player.connection, player.getStats(), player.getRecipeBook(), false, false);
        this.player = player;
        this.world = world;
    }
    ...
    public void sendChatMessage(String message) {
        this.player.sendChatMessage(message);
    }
    ...
    public void removeRecipeHighlight(IRecipe<?> p_193103_1_) {
        this.player.removeRecipeHighlight(p_193103_1_);
    }

    @Override
    public void setPermissionLevel(int level) {
        this.player.setPermissionLevel(level);
    ...
    public void setXPStats(float currentXP, int maxXP, int level) {
        this.player.setXPStats(currentXP, maxXP, level);
    }
    ...
    public void setShowDeathScreen(boolean p_228355_1_) {
        this.player.setShowDeathScreen(p_228355_1_);
    }
    ...
    protected boolean isCurrentViewEntity() {
        return this.mc.getRenderViewEntity() == this.player;
    }
    ...
    public void updateSyncFields(ClientPlayerEntity old) {
        this.player.updateSyncFields(old);
    }
    ...
    public boolean hasSkin() {
        return this.player.hasSkin();
    }

    @Override
    public ResourceLocation getLocationSkin() {
        return this.player.getLocationSkin();
    }

    @Nullable
    @Override
    public ResourceLocation getLocationCape() {
        return this.player.getLocationCape();
    }

    @Override
    public boolean isPlayerInfoSet() {
        return this.player.isPlayerInfoSet();
    }

    @Nullable
    @Override
    public ResourceLocation getLocationElytra() {
        return this.player.getLocationElytra();
    }

    @Override
    public String getSkinType() {
        return this.player.getSkinType();
    }
    ...
    public float getEyeHeight(Pose pose) {
        return this.player == null ? super.getEyeHeight(pose) : this.player.getEyeHeight(pose);
    }
