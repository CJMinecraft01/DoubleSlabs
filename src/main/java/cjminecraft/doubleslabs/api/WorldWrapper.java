...
public class WorldWrapper extends World implements IWorldWrapper<World> {
    ...
    public IBlockState getBlockState(BlockPos pos) {
        return pos.equals(this.pos) ? (this.positive ? this.container.getPositiveBlockInfo().getBlockState() : this.container.getNegativeBlockInfo().getBlockState()) : this.world.getBlockState(pos);
    }
