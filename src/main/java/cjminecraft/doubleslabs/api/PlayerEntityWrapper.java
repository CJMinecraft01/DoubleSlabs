...
public class PlayerEntityWrapper extends EntityPlayer implements IPlayerWrapper<EntityPlayer> {

    private final EntityPlayer player;

    public PlayerEntityWrapper(EntityPlayer player, World world) {
