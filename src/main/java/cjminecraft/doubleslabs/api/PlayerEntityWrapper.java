...
//        super(player.server, player.getServerWorld(), player.getGameProfile(), player.interactionManager);
    ...
    public void setRespawnPosition(BlockPos p_226560_1_, boolean p_226560_2_, boolean p_226560_3_) {
        this.player.setRespawnPosition(p_226560_1_, p_226560_2_, p_226560_3_);
    }

    @Override
    public void setSpawnPoint(@Nullable BlockPos p_226560_1_, boolean p_226560_2_, boolean p_226560_3_, DimensionType dim) {
        this.player.setSpawnPoint(p_226560_1_, p_226560_2_, p_226560_3_, dim);
    }
    ...
    public boolean isSuppressingSlidingDownLadder() {
        return this.player.isSuppressingSlidingDownLadder();
    }
    ...
    @Override
    public void positionRider(Entity p_226266_1_, IMoveCallback p_226266_2_) {
        this.player.positionRider(p_226266_1_, p_226266_2_);
    }
    ...
    public Entity changeDimension(DimensionType destination, ITeleporter teleporter) {
        return this.player.changeDimension(destination, teleporter);
    }
    ...
    @Override
    public void repositionDirectPassengers(IMoveCallback p_226265_1_) {
        this.player.repositionDirectPassengers(p_226265_1_);
    }
