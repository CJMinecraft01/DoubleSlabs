...
public class SlabConverterTileEntity extends SlabTileEntity {
    ...
    public void read(CompoundNBT nbt) {
        ...
        if (nbt.contains("negative_tile"))
            this.negativeBlockInfo.setTileEntity(TileEntity.create(nbt.getCompound("negative_tile")));
        ...
        if (nbt.contains("positive_tile"))
            this.positiveBlockInfo.setTileEntity(TileEntity.create(nbt.getCompound("positive_tile")));
    }
