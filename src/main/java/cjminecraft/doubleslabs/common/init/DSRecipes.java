...
public class DSRecipes {
    ...
    public static final RegistryObject<SimpleRecipeSerializer<VerticalSlabRecipe>> DYNAMIC_VERTICAL_SLAB = RECIPE_SERIALIZERS.register("dynamic_vertical_slab", () -> new SimpleRecipeSerializer<VerticalSlabRecipe>(VerticalSlabRecipe::new));
