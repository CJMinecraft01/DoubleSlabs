...
public class DSTiles {
    ...
    public static final RegistryObject<TileEntityType<SlabTileEntity>> DYNAMIC_SLAB = TILES.register("dynamic_slab", () -> TileEntityType.Builder.create(SlabTileEntity::new, DSBlocks.DOUBLE_SLAB.get()).build(null));
