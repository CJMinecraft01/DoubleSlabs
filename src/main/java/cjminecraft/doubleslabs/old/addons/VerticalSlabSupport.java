package cjminecraft.doubleslabs.old.addons;
...
public class VerticalSlabSupport<T extends Enum<T> & IStringSerializable> implements ISlabSupport {
    ...
    @Override
    public BlockState getStateForDirection(net.minecraft.world.World world, BlockPos pos, ItemStack stack, BlockItemUseContext context, Direction direction) {
    ...
    @Override
    public Direction getDirection(net.minecraft.world.World world, BlockPos pos, BlockState state) {
