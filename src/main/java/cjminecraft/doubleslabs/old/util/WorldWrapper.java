package cjminecraft.doubleslabs.old.util;
...
public class WorldWrapper extends World {
    ...
    public Vec3d getSkyColor(BlockPos p_217382_1_, float p_217382_2_) {
        return this.world.getSkyColor(p_217382_1_, p_217382_2_);
    }
    ...
    @Override
    public boolean func_217350_a(BlockState blockStateIn, BlockPos pos, ISelectionContext selectionContext) {
        return this.world.func_217350_a(blockStateIn, pos, selectionContext);
    }

    @Override
    public boolean areCollisionShapesEmpty(AxisAlignedBB aabb) {
        return this.world.areCollisionShapesEmpty(aabb);
    }

    @Override
    public boolean areCollisionShapesEmpty(Entity entityIn) {
        return this.world.areCollisionShapesEmpty(entityIn);
    }

    @Override
    public boolean isCollisionBoxesEmpty(Entity entityIn, AxisAlignedBB aabb) {
        return this.world.isCollisionBoxesEmpty(entityIn, aabb);
    }

    @Override
    public boolean isCollisionBoxesEmpty(@Nullable Entity entityIn, AxisAlignedBB aabb, Set<Entity> entitiesToIgnore) {
        return this.world.isCollisionBoxesEmpty(entityIn, aabb, entitiesToIgnore);
    }

    @Override
    public boolean isSkyLightMax(BlockPos pos) {
        return this.world.isSkyLightMax(pos);
    }
