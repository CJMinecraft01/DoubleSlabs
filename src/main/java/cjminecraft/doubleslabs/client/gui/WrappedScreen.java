...
public class WrappedScreen extends Screen implements IHasContainer<WrappedContainer> {
    ...
    public void render(int mouseX, int mouseY, float partialTicks) {
        getScreen().ifPresent(s -> s.render(mouseX, mouseY, partialTicks));
    }
    ...
    public boolean handleComponentClicked(ITextComponent component) {
        return getScreen().map(s -> s.handleComponentClicked(component)).orElseGet(() -> super.handleComponentClicked(component));
    }
    ...
    public void func_212932_b(@Nullable IGuiEventListener eventListener) {
        ...
        getScreen().ifPresent(s -> s.func_212932_b(eventListener));
    }
}
