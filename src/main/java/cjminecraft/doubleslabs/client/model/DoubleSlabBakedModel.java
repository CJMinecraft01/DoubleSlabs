...
public class DoubleSlabBakedModel extends DynamicSlabBakedModel {
    ...
    public List<BakedQuad> getQuads(@Nullable BlockState state, @Nullable Direction side, @Nonnull Random rand, @Nonnull IModelData extraData) {
        if (extraData.hasProperty(POSITIVE_BLOCK) && extraData.hasProperty(NEGATIVE_BLOCK)) {
            ...
            if ((!renderHalves || renderPositive) && (positiveState.canRenderInLayer(MinecraftForgeClient.getRenderLayer()) || MinecraftForgeClient.getRenderLayer() == null)) {
            ...
            if ((!renderHalves || !renderPositive) && (negativeState.canRenderInLayer(MinecraftForgeClient.getRenderLayer()) || MinecraftForgeClient.getRenderLayer() == null)) {
