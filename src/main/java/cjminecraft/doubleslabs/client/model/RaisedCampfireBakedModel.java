...
public class RaisedCampfireBakedModel implements IDynamicBakedModel {
    ...
    public List<BakedQuad> getQuads(@Nullable BlockState state, @Nullable Direction side, @Nonnull Random rand, @Nonnull IModelData extraData) {
        ...
        try {
            ...
            if (cacheKey.getRenderLayer() == state.getBlock().getRenderLayer() || cacheKey.getRenderLayer() == null)
                return cache.get(cacheKey, () ->
                    ...
                    .stream().map(quad ->
                            new BakedQuad(ClientUtils.offsetY(quad.getVertexData(), 0.5f),
                                    ...
                                    quad.getSprite(), quad.shouldApplyDiffuseLighting(), quad.getFormat())).collect(Collectors.toList()));
