...
public class AmbientOcclusionFace {
    ...
    public void updateVertexBrightness(IEnviromentBlockReader reader, BlockState state, BlockPos pos, Direction dir, float[] p_217629_5_, BitSet bits) {
        ...
        NeighborInfo blockmodelrenderer$neighborinfo = NeighborInfo.getNeighbourInfo(dir);
        ...
        VertexTranslations blockmodelrenderer$vertextranslations = VertexTranslations.getVertexTranslations(dir);
