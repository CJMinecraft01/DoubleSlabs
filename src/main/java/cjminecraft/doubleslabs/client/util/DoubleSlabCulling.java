...
public class DoubleSlabCulling {
    ...
    public static boolean shouldDoubleSlabSideBeRendered(BlockState state, ILightReader world, BlockPos pos, Direction direction) {
    ...
    public static boolean shouldSideBeRendered(BlockState state, ILightReader world, BlockPos pos, Direction direction, boolean positive) {
        BlockPos otherPos = pos.offset(direction);
        BlockState adjacentState = world.getBlockState(otherPos);
