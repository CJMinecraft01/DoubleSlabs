...
public class DoubleSlabCulling {
    ...
    public static boolean shouldDoubleSlabSideBeRendered(BlockState state, IEnviromentBlockReader world, BlockPos pos, Direction direction) {
    ...
    public static boolean shouldSideBeRendered(BlockState state, IEnviromentBlockReader world, BlockPos pos, Direction direction, boolean positive) {
        BlockPos otherPos = pos.offset(direction);
        BlockState adjacentState = world.getBlockState(otherPos);
    ...
    public static boolean shouldSideBeRendered(BlockState state, BlockState otherState, IBlockReader world, BlockPos pos, BlockPos otherPos, Direction direction) {
        ...
        if (state.isSideInvisible(otherState, direction)) {
            ...
            if (b0 != 127) {
                ...
                VoxelShape voxelshape = state.func_215702_a(world, pos, direction);
                VoxelShape voxelshape1 = otherState.func_215702_a(world, otherPos, direction.getOpposite());
