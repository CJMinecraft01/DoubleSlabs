...
//                this.transformation.accept(pos);
    ...
    public BakedQuad processOne(BakedQuad input) {
        ...
        return new BakedQuad(outData, getTintIndex(input), FaceBakery.getFacingFromVertexData(outData), input.func_187508_a(), input.shouldApplyDiffuseLighting());
    }
    ...
    public List<BakedQuad> processMany(List<BakedQuad> inputs) {
        ...
        for (BakedQuad input : inputs) {
            ...
            outputs.add(new BakedQuad(outData, getTintIndex(input), FaceBakery.getFacingFromVertexData(outData), input.func_187508_a(), input.shouldApplyDiffuseLighting()));
        }
        return outputs;
    }
